...
from auth.jwt import get_current_user, require_recruiter
...
def generate_questions(
    ...
    """Generate questions using AI (recruiter only)."""
    try:
...
def generate_and_save_questions(
    ...
    """Generate questions using AI and save them to database (recruiter only)."""
    try:
        ai_service = AIService()
        generated_questions = ai_service.generate_questions(
            topic=request.topic,
